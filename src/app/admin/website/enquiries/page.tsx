    ...
    <div>
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <a href="/admin/website/settings" className="btn-navy text-sm">
            Edit all website content
          </a>
          <a href="/admin/website/blog" className="btn-primary text-sm">
            Manage blog
          </a>
        </div>
      </div>
          ...
          {enquiries.map((enq) => (
            ...
            >
              ...
              <div className="mt-4 grid gap-2 text-sm sm:grid-cols-2 lg:grid-cols-3">
                ...
                <Info label="Email" value={enq.email || "ΓÇö"} />
                <Info label="Company" value={enq.company || "ΓÇö"} />
                <Info label="From" value={enq.fromCity || "ΓÇö"} />
                <Info label="To" value={enq.toCity || "ΓÇö"} />
                <Info label="Cargo" value={enq.cargoType || "ΓÇö"} />
                <Info label="Weight" value={enq.weight || "ΓÇö"} />
              </div>
              {enq.message && (
